...
As the accuracy of the model increases, the loss decreases. The final model has an accuracy of 89% and a loss of 0.43 The model is able to predict the class of the lesion with a high accuracy.
